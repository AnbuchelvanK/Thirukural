...
def searching(text):
  #Reading File
  df = pd.read_csv(r"C:\Users\anbuk\Downloads\Thirukural.csv")
...
# Open image path
image = Image.open(r"C:\Users\anbuk\Downloads\mic.jpg") 

image = image.resize((50, 50))  # resize image
photo = ImageTk.PhotoImage(image)

image2 = Image.open(r"C:\Users\anbuk\Downloads\thiruvalluvar.jpg")
image2 = image2.resize((150,200))
photo2 = ImageTk.PhotoImage(image2)

image3 = ImageTk.PhotoImage(Image.open(r"C:\Users\anbuk\Downloads\thirukural bg.jpg"))
